---
type: technique
id: source_backed_technique_ingestion
...
New videos, posts, docs, or repositories are added as inspiration.
...
techniques/registry.yaml or repos/registry.yaml

## Operating Notes

Store source metadata, extract only reusable patterns, avoid long copied transcripts, and require a reason before promoting a technique to mandatory status.
