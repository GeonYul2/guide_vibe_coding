---
type: technique
id: wiki_first_source_verification
source: techniques/registry.yaml
---

# Wiki-First Source Verification

## When to Apply

An agent answers questions or plans changes from a generated wiki, summaries, or knowledge graph.
...
retrieval-memory.md and eval-spec.md

## Operating Notes

Start from the wiki index for orientation, cite wiki pages, then verify decisions against canonical sources such as AGENTS.md, agent-playbook.yaml, technique registries, task artifacts, code, and radar YAML. Mark stale or unverified wiki claims as update tasks rather than treating them as authoritative.
