...
The agent can read/write files, call APIs, run commands, use browsers, or mutate business data.
...
Define tool allowlists, approval gates, sandbox boundaries, irreversible-action checks, timeouts, retries, idempotency, and audit logs.
