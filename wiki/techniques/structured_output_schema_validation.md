---
type: technique
id: structured_output_schema_validation
...
The agent emits JSON, YAML, Markdown specs, classifications, tool inputs, or downstream automation payloads.
...
output-schema.md and eval-spec.md
