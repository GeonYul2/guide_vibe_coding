---
type: technique
id: model_routing_fallback_policy
...
The agent has variable task difficulty, budget tiers, latency targets, reliability requirements, or batch/interactive modes.
...
model-routing.md and cost-and-caching.md
