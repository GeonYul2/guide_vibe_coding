---
type: technique
id: standardized_intake_gate
source: techniques/registry.yaml
---

# Standardized Intake Quality Gate

## When to Apply

Every new automation-agent task, before deep interview, PRD synthesis, technique selection, or implementation.
...
intake-form.md and agent-prd.md

## Operating Notes

Require a uniform first-input contract covering user, workflow pain, inputs, outputs, autonomy boundaries, non-goals, examples, tool/data access, and evidence of success. Missing fields must become explicit deep-interview follow-ups rather than silent assumptions.
